...
class COATOOLS2_OT_SelectFrameThumb(bpy.types.Operator):
    bl_idname = "coa_tools2.select_frame_thumb"
    ...
    def draw(self, context):
        ...
        row = layout.row()
        row.scale_y = 0.8
        row.template_icon_view(obj.coa_tools2, "sprite_frame_previews", scale=5)
    ...
    def invoke(self, context, event):
        ...
        if obj.coa_tools2.type == "SLOT" and len(obj.coa_tools2.slot) > 0:
            ...
            try:
                obj.coa_sprite_frame_previews = str(obj.coa_tools2.slot_index)
            except:
                pass
...
class COATOOLS2_OT_CreateSpritesheetPreview(bpy.types.Operator):
    bl_idname = "coa_tools2.create_spritesheet_preview"

...
class COATOOLS2_OT_CreateOrtpographicCamera(bpy.types.Operator):
    bl_idname = "coa_tools2.create_ortho_cam"
...
class COATOOLS2_OT_AlignCamera(bpy.types.Operator):
    bl_idname = "coa_tools2.align_camera"

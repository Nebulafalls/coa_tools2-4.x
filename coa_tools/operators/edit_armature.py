...
class COATOOLS_TO_DrawBone(bpy.types.WorkSpaceTool):
    ...
    bl_icon = os.path.join(
        functions.get_coa_tools_dir(), "icons", "coa_tools.draw_bone"
    )
    bl_widget = None
    # bl_keymap = (
    ...
    def modal(self, context, event):
        ...
        try:
                        ...
                        if ray[0] and ray[1] != None:
                            ...
                            if self.object_hover.coa_tools.type == "MESH":
                                ...
                                for i, slot in enumerate(
                                    self.object_hover.coa_tools.slot
                                ):
            ...
            if (
                ...
                or not self.sprite_object.coa_tools.edit_armature
            ):

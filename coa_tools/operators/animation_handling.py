...
class COATOOLS_OT_AddKeyframe(bpy.types.Operator):
            ...
            if self.add_keyframe:
                ...
                for sprite in sprites:  # context.selected_objects:
                    if (
                        ...
                        collection = sprite_object.coa_tools.anim_collections[
    ...
    def execute(self, context):
        ...
        if len(sprite_object.coa_tools.anim_collections) > 0:
            anim = sprite_object.coa_tools.anim_collections[
                sprite_object.coa_tools.anim_collections_index
            ]
...
class COATOOLS_OT_DuplicateAnimationCollection(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        if self.sprite_object != None:
            ...
            active_anim_collection = self.sprite_object.coa_tools.anim_collections[
                self.sprite_object.coa_tools.anim_collections_index
            ]
            ...
            self.sprite_object.coa_tools.anim_collections_index = (
                len(self.sprite_object.coa_tools.anim_collections) - 1
            )
...
class COATOOLS_OT_AddAnimationCollection(bpy.types.Operator):
        ...
        if self.sprite_object != None:
            ...
            if self.type == "NEW":
                item.name = check_name(
                    self.sprite_object.coa_tools.anim_collections, self.animation_name
                )
    ...
    def create_actions(self, context):
        item = self.sprite_object.coa_tools.anim_collections[
            self.sprite_object.coa_tools.anim_collections_index
        ]
...
class COATOOLS_OT_RemoveAnimationCollection(bpy.types.Operator):
    ...
    def remove_actions_collection(self, context):
        if self.sprite_object != None:
            if (
                self.sprite_object.coa_tools.anim_collections[
                    self.sprite_object.coa_tools.anim_collections_index
                ].name
                != "NO ACTION"
                and self.sprite_object.coa_tools.anim_collections[
                    self.sprite_object.coa_tools.anim_collections_index
                ].name
                != "Restpose"
            ):
                self.sprite_object.coa_tools.anim_collections.remove(
                    self.sprite_object.coa_tools.anim_collections_index
                )
            if self.sprite_object.coa_tools.anim_collections_index > 2:
                self.sprite_object.coa_tools.anim_collections_index = (
                    self.sprite_object.coa_tools.anim_collections_index - 1
                )
...
class COATOOLS_OT_CreateNlaTrack(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        if self.anim_collection_name == "":
            anim_collection = sprite_object.coa_tools.anim_collections[
                sprite_object.coa_tools.anim_collections_index
            ]
        else:
            anim_collection = sprite_object.coa_tools.anim_collections[
        ...
        if sprite_object != None:
            ...
            for i in range(len(sprite_object.coa_tools.anim_collections)):
                ...
                if anim_name not in ["NO ACTION", "Restpose"]:
                    ...
                    set_action(
                        context, item=sprite_object.coa_tools.anim_collections[i]
                    )
                    bpy.context.scene.frame_start = 0
                    bpy.context.scene.frame_end = (
                        sprite_object.coa_tools.anim_collections[
                            sprite_object.coa_tools.anim_collections_index
                        ].frame_end
                    )

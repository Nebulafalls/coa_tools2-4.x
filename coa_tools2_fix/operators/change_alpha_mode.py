...
class COATOOLS2_OT_ChangeAlphaMode(bpy.types.Operator):
    bl_idname = "coa_tools2.change_alpha_mode"
...
class COATOOLS2_OT_ChangeTextureInterpolationMode(bpy.types.Operator):
    bl_idname = "coa_tools2.change_texture_interpolation_mode"
